...
# # Home button
# home_button = Button(root, text="Home", font=("Arial", 16), bg="#FFA500", fg="white", padx=10, pady=5, command="")
# home_button.place(x=20, y=20)

# # Create the instant ride and charted ride buttons
# instant_button = Button(root, text="Instant Ride", font=("Arial", 18), bg="#4682B4", fg="white", padx=20, pady=10, command=instant_ride)
# instant_button.place(x=100, y=150, width=250, height=100)

# charted_button = Button(root, text="Chartered Ride", font=("Arial", 18), bg="#4682B4", fg="white", padx=20, pady=10, command=chartered_ride)
# charted_button.place(x=450, y=150, width=250, height=100)

# # Create the Next button
# next_button = Button(root, text="Next", font=("Arial", 18, "bold"), bg="#32CD32", fg="white", padx=20, pady=10)
# next_button.place(x=350, y=350, width=100, height=50)

# # Help button
# btn_help = Button(root, text="Help", font=("Arial", 18), bg="#FFA500", fg="white", padx=10, pady=5)
# btn_help.place(x=20, y=450, width=100, height=50)
